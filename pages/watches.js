...
const Watches = ({ products, mode }) => {

  return (
    <div>
      <Head>
        <title>Wear The Comfort-Watches Collection</title>
      </Head>
      <section className={mode ? `text-gray-300 body-font min-h-screen bg-[#232D3F]` : `text-gray-600 body-font min-h-screen`}>
        <div className="container px-5 py-16 mx-auto">
          <h2 className={mode ? 'text-center mb-10 text-2xl text-[#e9e7ee]' : "text-center mb-10 text-2xl text-black"}>Watches-collection</h2>
