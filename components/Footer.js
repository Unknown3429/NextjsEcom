...
const Footer = ({ image }) => {
    ...
    return (
        <footer className="text-gray-400 bg-gray-900 body-font mb-16 md:mb-0">
                    ...
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                        ...
                        <nav className="list-none mb-10">
                            {img && img?.map((item, i) => {
                                ...
                                return <li key={i} className='mt-1'>
                                    <Link href={`/${links}`} className="text-gray-400 hover:text-white">{item?.category.toUpperCase()}</Link>
                                </li>
                            })
                            }
                        </nav>
            ...
            <div className="bg-gray-800 bg-opacity-75">
                <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
                    <Link href="/" className="flex title-font font-medium items-center md:justify-start justify-center text-white">
                        ...
                        <span className="ml-3 text-xl">Next-Ecom</span>
                    </Link>
                    <p className="text-sm text-gray-400 sm:ml-6 sm:mt-0 mt-4">© 2023 Next-Ecom —
                        <Link href="/" className="text-gray-500 ml-1" target="_blank" rel="noopener noreferrer">@</Link>
                    </p>
